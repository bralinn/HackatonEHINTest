...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.no.LinnTest|current/StructureDefinition/mal-observation-blodprove)
