...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/LinnTest/ImplementationGuide/hl7.fhir.no.LinnTest | *Version*:0.1.0 |
...
```json
{
  ...
  "title" : "LinnTest",
  "status" : "draft",
  "date" : "2025-11-10T12:25:20+00:00",
  ...
  "definition" : {
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://hl7.no/fhir/ig/LinnTest/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      ...
      },
      {
        ...
        "exampleCanonical" : "http://hl7.no/fhir/ig/LinnTest/StructureDefinition/mal-patient"
      }
    ],
    "page" : {
      "extension" : [
