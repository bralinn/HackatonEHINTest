...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/LinnTest/ImplementationGuide/hl7.fhir.no.LinnTest | *Version*:0.0.1 |
| Draft as of 2025-11-10 | *Computable Name*:LinnTest |
...
```json
{
  ...
  "id" : "hl7.fhir.no.LinnTest",
  "url" : "http://hl7.no/fhir/ig/LinnTest/ImplementationGuide/hl7.fhir.no.LinnTest",
  "version" : "0.0.1",
  "name" : "LinnTest",
  "title" : "LinnTest",
  "status" : "draft",
  ...
  "description" : "Implementasjonsguide for å teste ut for eHiN Hackaton",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "packageId" : "hl7.fhir.no.LinnTest",
  "license" : "CC0-1.0",
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/no-Linn-Encounter"
        },
        "name" : "Linns Test Encounter",
      ...
      },
      {
        ...
        "isExample" : true,
        "profile" : [
          "http://hl7.no/fhir/ig/LinnTest/StructureDefinition/mal-patient"
        ]
      }
    ],
    "page" : {
    ...
    "parameter" : [
      ...
      },
      {
        ...
        "value" : "http://hl7.no/fhir/ig/LinnTest/history.html"
      },
      {
        "code" : {
          "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
